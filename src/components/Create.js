    ...
    <div className='container_all'>
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
            <div>
                ...
                <div>
                    <label className="label-create">HP: </label>
                ...
                <div>
                    <label className="label-create" >Attack: </label>
                ...
                <div>
                    <label className="label-create" >Defense: </label>
                ...
                <div>
                    <label className="label-create" >Speed: </label>
                ...
                <div>
                    <label className="label-create" >Height: </label>
                ...
                <div>
                    <label className="label-create" >Weight: </label>
                ...
                <div className='type_container'>
                    <label className="label-create" >Types: </label>
